...
- (void)dealloc {
    ...
    NSLog(@"dealloced audiocontroller");
...
static void audioUnitStreamFormatChanged(void *inRefCon, AudioUnit inUnit, AudioUnitPropertyID inID, AudioUnitScope inScope, AudioUnitElement inElement) {
    ...
    [THIS performSelectorOnMainThread:@selector(updateSampleRate) withObject:nil waitUntilDone:NO];
}
...
- (void)updateSampleRate {
    if ( !_useHardwareSampleRate || !_started) return;
